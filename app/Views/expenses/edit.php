            ...
            <div class="col-md-5">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input name="expense_date" class="form-control" value="<?php echo $expense->expense_date;?>">
                    </div>
                    <div class="col-md-6">
                        ...
                        <select name="supplier_id" class="form-control" required>
                            ...
                            <?php if(count($suppliers) > 0): ?>
                                <?php foreach($suppliers as $supplier): ?>
                                    <option value="<?php echo $supplier->id; ?>" <?php if($supplier->id == $expense->supplier_id){echo 'selected';};?>><?php echo $supplier->name; ?>
                                    </option>
                                <?php endforeach; ?>
                            <?php endif; ?> 
                        </select>
                ...
                <div class="row" style="margin-top: 12px;">
                    <div class="col-md-12">
                        <label>Remark</label>
                        <input class="form-control" name="remark" value="<?php echo $expense->remark;?>">
                    </div>
                </div>
                <div class="row" style="margin-top: 12px;">
                    <div class="col-md-12">
                        ...
                        if(!empty($expenses_items)){
                                ...
                                ?>
                                    <tr class="remall rem<?php echo $v->product_id;?>">
                                        ...
                                        <td><input name="price[]" id="p<?php echo $v->product_id;?>" onkeyup="recalc(<?php echo $v->product_id;?>)" type="text" value="<?php echo $v->price;?>" class="form-control" required></td>

                                        <td><input name="qty[]" id="q<?php echo $v->product_id;?>" onkeyup="recalc(<?php echo $v->product_id;?>)" type="text" value="<?php echo $v->qty;?>" class="form-control" required></td>

                                        <td><input name="sub_amount[]" id="subt<?php echo $v->product_id;?>" type="text" value="<?php echo $v->subtotal;?>" class="form-control subtot" required></td>
...
<script type="text/javascript">
    ...
    function removeitemdb(id, rid){
        ...
        $.ajax({
            type : 'POST',
            url: '<?php echo get_site_url('expenses/remove_expense_products'); ?>',
            data: {id: rid},
