            ...
            <div class="col-md-5">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input name="check_in" id="dateFrom" class="form-control" value="">
                    </div>

                    <div class="col-md-6">
                        <label>Discharge Date</label>
                        <input name="check_out" id="dateTo" class="form-control" value="">
                    </div>
                ...
                <div class="row" style="margin-top: 12px;">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="room_no" id="roomNo" class="form-control" required onchange="getroomrate()">
                            <option value="">Please Select</option>
                            <?php if(count($rooms) > 0): ?>
                                <?php foreach($rooms as $val): ?>
                                    <option  value="<?php echo $val->id; ?>" data-val="<?php echo $val->room_rate; ?>">
                ...
                <div class="row" style="margin-top: 12px;">
                    <div class="col-md-6">
                        ...
                        <input name="room_rate" id="roomRate" class="form-control" value="0" onchange="getroomrate()">
                        <input name="room_rate_amt" id="roomRateamt" type="hidden" value="0">
                        <input name="dayDiff" id="rdayDiff" type="hidden" value="0">
                        
                    </div>

                    <div class="col-md-6">
                        <label>Admission Reason</label>
                        <input name="admission_reason" class="form-control" value="">
