...
<section class="hide-on-print">
    ...
    <div class="form">
        <form action="<?php echo get_site_url("appointments/pay_operation");?>" method="post">
            ...
            <div class="row">
                <div class="col-md-6">
                    <p><strong>Operation Id:</strong> <?php echo $operation->unique_id;?></p>
                    <p><strong>Patient Name:</strong> <?php echo @$consumers[$operation->patient_id];?></p>
                </div>
                <div class="col-md-6">
                    
                    <a type="button" class="btn btn-danger btn-sm pull-right" onclick="fzPrint('sectiondata', 'Report')" style="margin-right: 6px;"> Receipt</a>

                    <button value="save" name="submit" type="submit" class="btn btn-success btn-sm pull-right" style="margin-right: 6px;"> <?php if($operation->pay_status != 'Pending'){echo 'All Paid';}else{echo 'Pay';}?> </button>
                </div>
            </div>
                    ...
                    <table class="table table-bordered table-striped table-condensed">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td id="duepay" style="text-align: left;padding-left: 12px !important;"><?php echo round($tot_price,2);?></td>
...
<div class="hidden">
    <div class="receipt" id="sectiondata" style="width: 80mm;text-align: center;">
        ...
        <div style="font-size: 12px;text-align: left;">
            <p style="margin-top: 10px;margin-bottom: 10px;">Receipt Number: <?php echo $operation->unique_id;?></p>
            <p style="margin-top: 10px;margin-bottom: 10px;">Patient: <?php echo @$consumers[$operation->patient_id];?></p>
        ...
        <table style="width: 100%;font-size: 12px;border-collapse: collapse;border-spacing: 0 10px;">
            ...
            $totamt = 0;
            if(!empty($operation_items)){ 
                    foreach ($operation_items as $key => $value) { $totamt += $value->subtotal; ?>
                        <tr>
        ...
        <div style="font-size: 12px;text-align: right;">
            ...
            <center><b style="margin-top: 10px;margin-bottom: 10px;">Total: <?php echo number_format($totamt,2);?></b></center>
