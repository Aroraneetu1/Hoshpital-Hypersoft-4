                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input name="operation_date" id="dateFrom" class="form-control" value="<?php echo $operation->operation_date;?>">
                            </div>
                        </div>
                        ...
                        <div class="row" style="margin-top: 12px;">
                            <div class="col-md-12">
                                ...
                                <input type="hidden" name="appointment_id" id="app_id" value="<?php echo $operation->appointment_id;?>">
                                <select name="patient_id" class="form-control" required onchange="getappid(this)" >
                                    ...
                                    <?php if(count($operationlist) > 0): ?>
                                        <?php foreach($operationlist as $val): ?>
                                            <option value="<?php echo $val->consumer_id; ?>" <?php if($val->consumer_id == $operation->patient_id){echo 'selected';};?> data-appid="<?php echo $val->id; ?>">
                                ...
                                <select name="doctor_id" class="form-control" required>
                                    ...
                                    <?php if(count($doctors) > 0): ?>
                                        <?php foreach($doctors as $val): ?>
                                            <option value="<?php echo $val->id; ?>" <?php if($val->id == $operation->doctor_id){echo 'selected';};?>><?php echo $val->first_name.' '.$val->last_name; ?></option>
                                        <?php endforeach; ?>
                                    <?php endif; ?> 
                                </select>
                            </div>
                        ...
                        <div class="row" style="margin-top: 12px;">
                            ...
                            <div class="col-md-12">
                                ...
                                <select name="ass_doctor_id" class="form-control" required>
                                    ...
                                    <?php if(count($doctors) > 0): ?>
                                        <?php foreach($doctors as $val): ?>
                                            <option value="<?php echo $val->id; ?>" <?php if($val->id == $operation->ass_doctor_id){echo 'selected';};?>>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <textarea name="operation_reason" class="form-control" rows="11" required><?php echo $operation->operation_reason;?></textarea>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function removeitemdb(id, rid){
        ...
        $.ajax({
            type : 'POST',
            url: '<?php echo get_site_url('appointments/remove_operation_products'); ?>',
            data: {id: rid},
