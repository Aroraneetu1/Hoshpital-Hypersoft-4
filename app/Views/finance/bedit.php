    ...
    <form action="" class="cmxform form-horizontal form-example" method="post">
        <div class="form-group">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xm-12">
                ...
                <input type="text" class="form-control" name="branch_code" value="<?php echo $row->branch_code; ?>"> 
                <span class="error"><?php echo $validation->getError("branch_code"); ?></span>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-4 col-xm-12">
                <label>Bank Phone</label>
                <input type="text" class="form-control" name="bank_phone" value="<?php echo $row->bank_phone; ?>"> 
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xm-12">
                ...
                <input type="text" class="form-control" name="opening_balance" value="<?php echo $row->opening_balance; ?>"> 
                <span class="error"><?php echo $validation->getError("opening_balance"); ?></span>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-4 col-xm-12">
                <label>Current Balance</label>
                <input type="text" class="form-control" name="current_balance" value="<?php echo $row->current_balance; ?>"> 
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xm-12">
                ...
                <select class="form-control" name="main_account">
                    <?php foreach($yes_no_option as $key => $value): ?>
                        <option value="<?php echo $key; ?>" <?php if($key == $row->main_account){echo 'selected';}?>><?php echo $value; ?></option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xm-12">
                ...
                <select class="form-control" name="payment_type">
                    ...
                    <?php foreach($paymenttypes as $key => $value): ?>
                        <option value="<?php echo $value->id; ?>" <?php if($value->id == $row->payment_type){echo 'selected';}?>><?php echo $value->name; ?></option>
                    <?php endforeach; ?>
                </select>
